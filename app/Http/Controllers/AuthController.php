...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request)
    {
        try {
            ...
            if(!$user) {
                return ApiResponse::sendErrorResponse('User dengan email tersebut tidak ditemukan', 'User not found');
            }

            if(! Hash::check($validated['password'], $user->password)) {
                return ApiResponse::sendErrorResponse('Email atau password salah', 'Invalid credentials');
            }
            ...
            return ApiResponse::sendErrorResponse('failed to login', $e->getMessage());
        }
    }
